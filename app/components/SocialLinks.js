export default function SocialLinks({ className = "" }) {
  const links = [
    ...
    },
    {
      ...
      icon: "M20.216 6.415l-.132-.666c-.119-.598-.388-1.163-.806-1.68C18.581 3.139 17.324 2.5 16 2.5H8c-1.324 0-2.581.639-3.278 1.569-.418.517-.687 1.082-.806 1.68l-.132.666A3.001 3.001 0 0 0 6 12v6a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3v-6a3.001 3.001 0 0 0 2.216-5.585zM18 12v6a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1z"
    }
  ];
